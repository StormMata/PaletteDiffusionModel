#!/bin/bash
#SBATCH -J real_25b                # job name
#SBATCH --nodes=1                  #
#SBATCH --time=0-12:00:00          # set time limit
...
conda run --no-capture-output -n diffusion python3 run.py -c config/mask_test_2.json -gpu 0,1,2,3 -b 32
